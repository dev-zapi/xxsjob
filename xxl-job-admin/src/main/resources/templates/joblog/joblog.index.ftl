  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal form" role="form" name="clear-log-form" id="clear-log-form">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary ok" form="clear-log-form">${I18n.system_ok}</button>
      </div>
    </div>
  </div>
</div>
